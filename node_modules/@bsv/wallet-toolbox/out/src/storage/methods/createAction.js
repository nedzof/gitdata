...
async function createNewOutputs(storage, userId, vargs, ctx, changeOutputs) {
    ...
    for (const { o, tags } of newOutputs) {
        ...
        const ro = {
            ...
            satoshis: (0, validationHelpers_1.validateSatoshis)(o.satoshis, 'o.satoshis'),
...
async function validateRequiredInputs(storage, userId, vargs) {
    ...
    for (const input of xinputs) {
        ...
        if (output) {
            ...
            input.satoshis = (0, validationHelpers_1.validateSatoshis)(output.satoshis, 'output.satoshis');
            ...
            input.satoshis = (0, validationHelpers_1.validateSatoshis)(so.satoshis, 'so.satoshis');
