...
describe('OutputTagMap class method tests', () => {
    ...
    test('0_OutputTagMap getters and setters', async () => {
        ...
        const outputTagMap = new EntityOutputTagMap_1.EntityOutputTagMap(initialData);
        // Test getters
    ...
    test('1_equals returns true for matching entities', async () => {
        ...
        const entity1 = new EntityOutputTagMap_1.EntityOutputTagMap(outputTagMapData);
        const entity2 = new EntityOutputTagMap_1.EntityOutputTagMap(outputTagMapData);
    ...
    test('2_equals returns false for non-matching entities', async () => {
        ...
        // Create entities from the records
        const entity1 = new EntityOutputTagMap_1.EntityOutputTagMap(outputTagMapData1);
        const entity2 = new EntityOutputTagMap_1.EntityOutputTagMap(outputTagMapData2);
        const syncMap = (0, src_1.createSyncMap)();
    ...
    test('3_mergeExisting merges and updates entity when ei.updated_at > this.updated_at', async () => {
        ...
        const entity = new EntityOutputTagMap_1.EntityOutputTagMap(initialData);
