...
describe('ArcGorillaPool tests', () => {
    ...
    const arc = new ARC_1.ARC((0, createDefaultWalletServicesOptions_1.arcGorillaPoolUrl)(env.chain), {
        apiKey: ''
    });
    ...
    test.skip('1 postRawTx', async () => {
        ...
        (0, TestUtilsWalletStorage_1.logger)(`2 postBeef mainnet done ${r}`);
    });
...
//# sourceMappingURL=ArcGorillaPool.man.test.js.map