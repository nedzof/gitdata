...
describe('bitrails tests', () => {
    ...
    test('0 verify merkle proof to merkle path', async () => {
        const mp = (0, index_client_1.convertProofToMerklePath)('068f2ce0d01b5f1e7c7a07c209c3c67d583aeae83e11e92801b51c36f81d6b67', proof2);
    ...
    test('1 ', async () => {
        const chain = 'main';
        const bitails = new Bitails_1.Bitails(chain);
...
//# sourceMappingURL=bitrails.test.js.map