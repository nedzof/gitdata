...
const index_client_1 = require("../chaintracks/index.client");
...
describe('ChaintracksServiceClient tests', () => {
    ...
    test('0 mainNet findHeaderForHeight', async () => {
        ...
        expect(r === null || r === void 0 ? void 0 : r.hash).toBe('00000000000000000b010edee7422c59ec9131742e35f3e0d5837d710b961406');
    ...
    test('1 testNet findHeaderForHeight', async () => {
        ...
        expect(r === null || r === void 0 ? void 0 : r.hash).toBe('0000000049686fe721f70614c89df146e410240f838b8f3ef8e6471c6dfdd153');
        expect(await client.findHeaderForHeight(999999999)).toBe(undefined);
    });
});
function makeClient(chain) {
    ...
    return new index_client_1.ChaintracksServiceClient(chain, chaintracksUrl);
}
//# sourceMappingURL=ChaintracksServiceClient.test.js.map