...
const ChaintracksStorageIdb_1 = require("../ChaintracksStorageIdb");
const ChaintracksStorageBase_1 = require("../ChaintracksStorageBase");
describe('ChaintracksStorageIdb tests', () => {
    jest.setTimeout(99999999);
    test('0', async () => {
        const options = ChaintracksStorageBase_1.ChaintracksStorageBase.createStorageBaseOptions('main');
        const storage = new ChaintracksStorageIdb_1.ChaintracksStorageIdb(options);
...
//# sourceMappingURL=ChaintracksStorageIdb.test.js.map