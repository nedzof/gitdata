...
export function enhancedOverlayRouter(): EnhancedOverlayRouter {
  ...
  router.post(
    ...
    async (req: Request, res: Response) => {
      try {
        const { filename, contentType, totalSize, chunkSize, enableStreaming, streamingProfiles } =
          req.body;
  ...
  router.post(
    '/files/stream/:uploadId/complete',
    requireOverlay,
    async (req: Request, res: Response) => {
      res.status(501).json({
        error: 'not-implemented',
  ...
  router.get(
    '/files/stream/:hash/:profile/playlist.m3u8',
    rateLimit(50, 60000),
    async (req: Request, res: Response) => {
      res.status(501).json({
        error: 'not-implemented',
  ...
  router.get(
    '/files/stream/:hash/:profile/segment_:index.ts',
    rateLimit(100, 60000),
    async (req: Request, res: Response) => {
      res.status(501).json({
        error: 'not-implemented',
  ...
  router.get(
    '/files/stream/:hash/manifest.mpd',
    rateLimit(50, 60000),
    async (req: Request, res: Response) => {
      res.status(501).json({
        error: 'not-implemented',
