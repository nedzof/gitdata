...
export class D22StorageSchema {
  ...
  static readonly OVERLAY_STORAGE_INDEX_INDEXES = [
  ...
  static readonly STORAGE_VERIFICATIONS_INDEXES = [
  ...
  static readonly STORAGE_ACCESS_LOGS_INDEXES = [
  ...
  static readonly STORAGE_REPLICATIONS_INDEXES = [
  ...
  static readonly UHRP_ADVERTISEMENTS_INDEXES = [
  ...
  static readonly STORAGE_CACHE_STATS_INDEXES = [
  ...
  static readonly STORAGE_ROUTING_LOGS_INDEXES = [
  ...
  static readonly STORAGE_AGENT_REGISTRY_INDEXES = [
  ...
  static readonly STORAGE_PERFORMANCE_METRICS_INDEXES = [
   ...
   */
  static async applySchema(pool: Pool): Promise<void> {
   ...
   */
  static async createViews(pool: Pool): Promise<void> {
    const views = [
      {
   ...
   */
  static async seedTestData(pool: Pool): Promise<void> {
