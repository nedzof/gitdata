...
export interface GitdataServerOptions {
  port: number
...
export interface GitdataRoute {
  ...
  func: (req: Request, res: Response, server: GitdataServer) => Promise<any>
}

export class GitdataServer {
  ...
  constructor(storage: any, options: GitdataServerOptions) {
  ...
  public start(): void {
    this.app.listen(this.port, () => {
      console.log(`GitdataServer listening at http://localhost:${this.port}`)
    })
  }
