...
exports.PostgreSQLBRC88SHIPSLAPService = exports.PostgreSQLBRC64HistoryService = exports.PostgreSQLBRC24LookupService = exports.PostgreSQLBRC22SubmitService = void 0;
...
class QueryBuilder {
    ...
    static createIndex(indexName, table, columns, unique = false) {
...
class PostgreSQLBRC22SubmitService extends events_1.EventEmitter {
    constructor(database) {
        super();
        this.topicManagers = new Map();
        this.trackedUTXOs = new Map();
    ...
    setupDefaultTopicManagers() {
        ...
        this.addTopicManager({
            ...
            admittanceLogic: (transaction, outputIndex) => {
                ...
                return (transaction.topics.includes('gitdata.d01a.asset') ||
    ...
    async processSubmission(transaction, requesterId) {
        try {
    ...
    async processTransactionForTopic(transaction, txid, topic, manager) {
    ...
    async admitUTXO(txid, vout, topic, output, manager) {
    ...
    async getStats() {
        const stats = { topics: {}, transactions: { total: 0, recent: 0 } };
...
exports.PostgreSQLBRC22SubmitService = PostgreSQLBRC22SubmitService;
class PostgreSQLBRC24LookupService extends events_1.EventEmitter {
    constructor(database, brc22Service) {
        super();
    ...
    addLookupProvider(provider) {
        this.providers.set(provider.providerId, provider);
    }
    async processLookup(providerId, query, requesterId) {
        try {
...
exports.PostgreSQLBRC24LookupService = PostgreSQLBRC24LookupService;
class PostgreSQLBRC64HistoryService extends events_1.EventEmitter {
...
exports.PostgreSQLBRC64HistoryService = PostgreSQLBRC64HistoryService;
class PostgreSQLBRC88SHIPSLAPService extends events_1.EventEmitter {
    ...
    async createSHIPAdvertisement(topicName) {
        const identity = wallet_1.walletService.getPublicKey() || 'anonymous';
        const timestamp = Date.now();
        const message = `SHIP|${identity}|${this.domain}|${topicName}|${timestamp}`;
        const signature = await wallet_1.walletService.signData(message, 'ship-advertisement');
        const advertisement = {
    ...
    async createSLAPAdvertisement(serviceId) {
        ...
        const signature = await wallet_1.walletService.signData(message, 'slap-advertisement');
        const advertisement = {
            advertiserIdentity: identity,
            domainName: this.domain,
            serviceId,
...
exports.PostgreSQLBRC88SHIPSLAPService = PostgreSQLBRC88SHIPSLAPService;
//# sourceMappingURL=brc-services-postgresql.js.map