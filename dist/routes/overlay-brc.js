...
exports.overlayBrcRouter = void 0;
...
function enhancedOverlayRouter() {
    ...
    router.get('/lookup/providers', requireOverlay, (req, res) => {
        try {
    ...
    router.get('/history/:utxoId', requireOverlay, async (req, res) => {
        try {
    ...
    router.get('/lineage/:utxoId', requireOverlay, async (req, res) => {
        try {
            const { utxoId } = req.params;
            const { topic, depth = 5 } = req.query;
            const graph = await overlayServices.brc64Service.generateLineageGraph(utxoId, topic, parseInt(depth));
            res.json({
                success: true,
                utxoId,
                graph,
    ...
    router.get('/services/ship', requireOverlay, async (req, res) => {
        try {
    ...
    router.get('/services/slap', requireOverlay, async (req, res) => {
        try {
    ...
    router.post('/services/advertise', requireOverlay, (0, identity_1.requireIdentity)(true), async (req, res) => {
        try {
    ...
    router.post('/files/store', requireOverlay, (0, identity_1.requireIdentity)(true), upload.single('file'), rateLimit(5, 60000), async (req, res) => {
        try {
            if (!req.file) {
                return res.status(400).json({
                    error: 'no-file',
    ...
    router.get('/files/download/:hash', rateLimit(50, 60000), async (req, res) => {
        try {
    ...
    router.get('/files/resolve/:hash', requireOverlay, async (req, res) => {
        try {
            const { hash } = req.params;
    ...
    router.get('/files/stats', requireOverlay, async (req, res) => {
        try {
    ...
    router.post('/subscribe', requireOverlay, (0, identity_1.requireIdentity)(true), async (req, res) => {
        try {
    ...
    router.post('/publish', requireOverlay, (0, identity_1.requireIdentity)(true), async (req, res) => {
        try {
...
exports.overlayBrcRouter = enhancedOverlayRouter;
//# sourceMappingURL=overlay-brc.js.map