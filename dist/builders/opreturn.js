...
exports.buildOpReturnScriptMulti = buildOpReturnScriptMulti;
exports.composeTag = composeTag;
exports.pushdataHeaderLen = pushdataHeaderLen;
exports.varIntSize = varIntSize;
exports.opReturnScriptLen = opReturnScriptLen;
exports.opReturnOutputSize = opReturnOutputSize;
function ascii(s) {
...
function buildOpReturnScript(blob) {
    const OP_FALSE = 0x00;
...
function buildOpReturnScriptMulti(blobs) {
    const OP_FALSE = 0x00;
    const OP_RETURN = 0x6a;
 ...
 */
function composeTag(tag, cborBytes) {
...
function pushdataHeaderLen(len) {
    if (len < 0x4c)
        return 1;
    if (len <= 0xff)
        return 2;
...
function opReturnScriptLen(dataLen) {
...
function opReturnOutputSize(dataLen) {
