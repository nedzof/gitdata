...
exports.publishArtifactToDLM1 = publishArtifactToDLM1;
exports.publishContractArtifact = publishContractArtifact;
exports.createArtifactRoutes = createArtifactRoutes;
const crypto_1 = require("crypto");
function generateContentHash(content) {
    return (0, crypto_1.createHash)('sha256').update(content, 'utf8').digest('hex');
}
function createDLM1Manifest(artifact) {
...
async function publishArtifactToDLM1(db, artifactId, overlayUrl = 'http://localhost:8788') {
    try {
...
async function publishContractArtifact(db, jobId, contractContent, contractMetadata, overlayUrl = 'http://localhost:8788') {
    try {
...
function createArtifactRoutes(db) {
...
//# sourceMappingURL=dlm1-publisher.js.map